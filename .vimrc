...
set number                        " display current lines absolute
set cursorline                    " highlight the current line
set showmatch                     " highlight matching [{()}]
set laststatus=2                  " always display the statusbar
set noerrorbells visualbell t_vb= " turn off the bell
...
set modelines=1 " enable a line in a file which tells vim how to handle it
...
set smartcase  " if pattern contains capital letter search is case-sensitive
...
nmap <C-p> :Files<CR> " search for files
